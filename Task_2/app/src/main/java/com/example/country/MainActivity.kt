...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var switchViewButton: ImageButton
    lateinit var searchbar:EditText
    lateinit var recycler:RecyclerView
    private var ascending=true
    lateinit var sortBtn:ImageButton
    var adapter = CustomAdapter(countries,LIST) // Accessing the Adapter class
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       switchViewButton=findViewById(R.id.switchView)
        switchViewButton.setOnClickListener {
            ...
            if (type==GRID)
            {
                adapter= CustomAdapter(countries,LIST)
                recycler.layoutManager = LinearLayoutManager(this, RecyclerView.VERTICAL, false)
            ...
            {
                adapter= CustomAdapter(countries,GRID)
